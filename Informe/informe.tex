...
Los áridos fluviales monotamaño presentan menor contenido de finos, con una distribución granulométrica variable. Esto disminuye el volumen de pasta disponible para envolver los áridos, reduciendo la cohesión y aumentando la probabilidad atascamiento en la enfierradura o mangueras de bombeo. Para que esto no ocurra, se debe aumentar el contenido de finos con una mayor dósis de cemento o adiciones minerales, como filler calizo o puzolanas, lo que ayuda a mejorar la estabilidad y la resistencia a la segregación del HAC \citep{EFNARC2002,EuropeanGuidelines2005}.

Además, el uso de aditivos debe adaptarse a estas condiciones locales. Los superplastificantes permiten alcanzar alta fluidez manteniendo una baja razón w/c, mientras que los modificadores de viscosidad incrementan la cohesión y bajan la segregación, importante cuando la granulometría es monotamaño. Aún así, dada la variabilidad de humedad en los acopios de áridos sureños, el control de la dósis de aditivo debe ser muy preciso, ya que podría generar pérdida de asentamiento o sobrefluidez, desestabilizando la mezcla \citep{NPCA_SCC_2024,CCAA_ConcreteGuide_2020}.

Las condiciones ambientales también influyen en el desarrollo del HAC. Climas fríos y húmedos pueden retardar el fraguado y la ganancia de resistencia temprana, es común incorporar acelerantes de fraguado en invierno. Por otro lado, si el tiempo de vaciado es prolongados o es una gran superficie, el uso de retardadores es mejor. La ACI 237R dice que la retención de asentamiento es un factor crítico para el comportamiento del HAC en climas fríos y húmedos y en obras con accesibilidad reducida \citep{ACI237R07}.

Con todos los inconvenientes que se presentan al trabajr en climas extremos, hay que añadir las distancias entre planta y obra, los accesos rurales y la irregularidad del terreno. Para esto se recomiendan aditivos con alta retención de trabajabilidad y estabilidad frente a un mezclado de largo tiempo. \citep{EuropeanGuidelines2005}.

Finalmente, los aditivos MC Bauchemie, \citep{MCAdditives2024}, recomendados para estas condiciones son:
\begin{itemize}
    \item Superplastificantes de tecnología policarboxilato para entregar alta fluidez y retención de asentamiento sin aumentar la relación w/c.
    \item Modificadores de viscosidad (VMA) para estabilizar la mezcla frente a granulometrías monotamaño y minimizar segregación y sangrado.
    \item Retardadores según clima y tipo de vaciado, permitiendo controlar tiempos de fraguado y continuidad de obra.
\end{itemize}
